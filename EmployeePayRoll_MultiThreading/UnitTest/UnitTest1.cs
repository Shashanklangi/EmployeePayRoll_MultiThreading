...
namespace EmployeePayRollTestCases
{
    public class Tests
    {
        ...
        public void CheckingTime_Required_For_Inserting_Details()
        {
            ...
            employeeDetails.Add(new EmployeeDetails(ID: 24, Name: "Charles", StartDate: Convert.ToDateTime("2024-07-17"), Gender: "M", PhoneNumber: 8475123698, Address: "Miami", Department: "Claims", BasicPay: 62000, Deduction: 300, TaxablePay: 200, IncomeTax: 100, NetPay: 61400));
            ...
            employeeDetails.Add(new EmployeeDetails(ID: 27, Name: "Serena", StartDate: Convert.ToDateTime("2024-03-02"), Gender: "F", PhoneNumber: 745124639, Address: "Miami", Department: "Claims", BasicPay: 62000, Deduction: 300, TaxablePay: 200, IncomeTax: 100, NetPay: 61400));
